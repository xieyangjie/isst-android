...
public class CSTJsonParser {
    ...
    public static <K, V> Map<K, V> readString(String jsonStr, Class <? extends Map> mapClazz ,Class<K> keyClazz,
    ...
    public static <K, V> Map<K, V> readString(String jsonStr, Class <? extends Map> mapClazz ,JavaType keyJavaType,
     ...
     */
    public static JavaType collectionToJavaType(Class <? extends List> collectionClazz, Class <?> elementClazz){
     ...
     */
    public static JavaType collectionToJavaType(Class <? extends List> collectionClazz, JavaType elementJavaType){
