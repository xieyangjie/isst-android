...
public class CSTCommentDataDelegate {
    public static CSTComment getComment(Cursor cursor) {
        ...
        comment.content = cursor.getString(cursor.getColumnIndex(CSTCommentProvider.Columns.CONTENT.key));
        comment.user = (CSTUser) Tools.antiserialize(cursor.getBlob(cursor.getColumnIndex(CSTCommentProvider.Columns.CSTUSER.key)));
        return comment;
    }
    ...
    public static CSTComment getCommet(Context context, String id) {
        ...
        Cursor cursor = resolver
                .query(CSTCommentProvider.CONTENT_URI, null, CSTCommentProvider.Columns.ID.key + " = ?",
                        new String[]{
                                id
                        }, null
                );
    ...
    private static ContentValues getCommentValue(CSTComment comment) {
        ...
        values.put(CSTCommentProvider.Columns.CSTUSER.key, Tools.serialize(comment.user));
        return values;
    }
}
