...
public class CSTCityParticipantDataDelegate {
    public static CSTCityParticipant getCityParticipant(Cursor cursor){
        ...
        cityParticipant.id=cursor.getInt(cursor.getColumnIndex(CSTCityParticipantProvider.Columns.ID.key));
        ...
        cityParticipant.clazzId=cursor.getInt(cursor.getColumnIndex(CSTCityParticipantProvider.Columns.CLASS_ID.key));
        cityParticipant.clazzName=cursor.getString(cursor.getColumnIndex(CSTCityParticipantProvider.Columns.CLASS_NAME.key));
        cityParticipant.major=cursor.getString(cursor.getColumnIndex(CSTCityParticipantProvider.Columns.MAJOR.key));
        cityParticipant.email=cursor.getString(cursor.getColumnIndex(CSTCityParticipantProvider.Columns.EMAIL.key));
        cityParticipant.phoneNum=cursor.getString(cursor.getColumnIndex(CSTCityParticipantProvider.Columns.PHONE.key));
        cityParticipant.qqNum=cursor.getString(cursor.getColumnIndex(CSTCityParticipantProvider.Columns.QQ.key));
        cityParticipant.company=cursor.getString(cursor.getColumnIndex(CSTCityParticipantProvider.Columns.COMPANY.key));
        cityParticipant.jobTitle=cursor.getString(cursor.getColumnIndex(CSTCityParticipantProvider.Columns.JOB_TITLE.key));
        cityParticipant.signature=cursor.getString(cursor.getColumnIndex(CSTCityParticipantProvider.Columns.SIGN.key));
        cityParticipant.cityId=cursor.getString(cursor.getColumnIndex(CSTCityParticipantProvider.Columns.CITY_ID.key));
        cityParticipant.cityName=cursor.getString(cursor.getColumnIndex(CSTCityParticipantProvider.Columns.CITY_NAME.key));
        return cityParticipant;
    }
    public static CSTCityParticipant getCityParticipant(Context context, String id) {
        ContentResolver resolver = context.getContentResolver();
        Cursor cursor = resolver
                .query(CSTCityParticipantProvider.CONTENT_URI, null, CSTCityParticipantProvider.Columns.ID.key + " = ?",
                        new String[]{
                                id
                        }, null);
    ...
    public static void saveCityParticipant(Context context, CSTCityParticipant cityParticipant) {
        ContentResolver resolver = context.getContentResolver();
        resolver.insert(CSTCityParticipantProvider.CONTENT_URI, getCityParticipantValue(cityParticipant));
    }
    ...
    private static ContentValues getCityParticipantValue(CSTCityParticipant cityParticipant) {
        ...
        values.put(CSTCityParticipantProvider.Columns.GENDER.key,cityParticipant.gender.getTypeName());
