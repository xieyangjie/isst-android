...
public class CSTCityDataDelegate {
    public static CSTCity getCity(Cursor cursor){
        ...
        city.cityMaster=(CSTUser) Tools.antiserialize(cursor.getBlob(cursor.getColumnIndex(CSTCityProvider.Columns.CITY_MASTER.key)));
        return city;
    }
    ...
    private static ContentValues getCityValue(CSTCity city) {
        ...
        values.put(CSTCityProvider.Columns.CITY_MASTER.key,Tools.serialize(city.cityMaster));
        return values;
    }
}
