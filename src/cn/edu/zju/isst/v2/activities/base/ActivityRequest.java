package cn.edu.zju.isst.v2.activities.base;
 ...
 */
public class ActivityRequest extends CSTJsonRequest {
    ...
    public ActivityRequest(int method, String subUrl,
    ...
    public ActivityRequest setPage(int page) {
        this.page = page;
        hasParams = true;
        return this;
    }

    public ActivityRequest setPageSize(int pageSize) {
        this.pageSize = pageSize;
        hasParams = true;
        return this;
    }

    public ActivityRequest setKeywords(String keywords) {
