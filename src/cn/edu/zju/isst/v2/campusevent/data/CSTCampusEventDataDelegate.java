...
public class CSTCampusEventDataDelegate {
    public static CSTCampusEvent getCampusEvent(Cursor cursor) {
        ...
        campusevent.id = cursor.getInt(cursor.getColumnIndex(CSTCampusEventProvider.Columns.ID.key));
        campusevent.title = cursor
                .getString(cursor.getColumnIndex(CSTCampusEventProvider.Columns.TITLE.key));
        campusevent.picture = cursor.getString(cursor.getColumnIndex(CSTCampusEventProvider.Columns.PICTURE.key));
        campusevent.description = cursor.getString(cursor.getColumnIndex(CSTCampusEventProvider.Columns.DESCRIPTION.key));
        campusevent.content = cursor.getString(cursor.getColumnIndex(CSTCampusEventProvider.Columns.CONTENT.key));
        campusevent.pubName = cursor.getString(cursor.getColumnIndex(CSTCampusEventProvider.Columns.PUBLISHER_NAME.key));
        campusevent.updatedAt = cursor.getInt(cursor.getColumnIndex(CSTCampusEventProvider.Columns.UPDATEAT.key));
        campusevent.startTime = cursor.getInt(cursor.getColumnIndex(CSTCampusEventProvider.Columns.STARTTIME.key));
        campusevent.expireTime = cursor.getInt(cursor.getColumnIndex(CSTCampusEventProvider.Columns.EXPIRETIME.key));
        return campusevent;
    }
    ...
    public static CSTCampusEvent getCampusEvent(Context context, String id) {
        ...
        Cursor cursor = resolver
                .query(CSTCampusEventProvider.CONTENT_URI, null, CSTCampusEventProvider.Columns.ID.key + " = ?",
                        new String[]{
                                id
                        }, null
                );
