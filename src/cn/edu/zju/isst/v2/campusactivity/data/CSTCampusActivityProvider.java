 ...
 */
public class CSTCampusActivityProvider extends SimpleTableProvider{
    public enum Columns{
        ID("id"),
        TITLE("title"),
        PICTURE("picture"),
    ...
    public static final String TABLE_NAME = "campusactivity";
    ...
    public CSTCampusActivityProvider(Context context) {
        super(context);
    }
