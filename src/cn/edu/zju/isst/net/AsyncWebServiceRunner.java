...
import cn.edu.zju.isst.api.HttpUtil;
...
public class AsyncWebServiceRunner {
     ...
     * @param listener    回调对象
     */
	public static void request( final String methodName, final String url, final Map<String,String> params, final RequestListener listener) 
	{
		new Thread() 
		{
			@Override
			public void run() 
			{
				try 
				{
					...
					if (methodName == "get")
					{
						...
						if (tempResult!=null && tempResult.charAt(0) =='[') {
					...
					//	result = new JSONObject(HttpUtil.postRequest(url, params));
					}
