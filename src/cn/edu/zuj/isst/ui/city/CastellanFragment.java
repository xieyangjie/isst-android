 ...
 * 
 */
package cn.edu.zuj.isst.ui.city;
...
public class CastellanFragment extends Fragment {
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		//控件
		m_tvName = (TextView)view.findViewById(R.id.castellan_fragment_name_txv);
		m_tvGender = (TextView)view.findViewById(R.id.castellan_fragment_gender_txv);
		m_tvGrade = (TextView)view.findViewById(R.id.castellan_fragment_grade_txv);
		m_tvMajor = (TextView)view.findViewById(R.id.castellan_fragment_major_txv);
		m_tvMobile = (TextView)view.findViewById(R.id.castellan_fragment_mobile_txv);
		m_tvCity = (TextView)view.findViewById(R.id.castellan_fragment_city_txv);
		m_tvCompany = (TextView)view.findViewById(R.id.castellan_fragment_company_txv);
		m_tvEmail = (TextView)view.findViewById(R.id.castellan_fragment_email_txv);
		m_ibtnMobileCall = (ImageButton)view.findViewById(R.id.castellan_fragment_mobile_ibtn);
		m_tvPosition = (TextView)view.findViewById(R.id.castellan_fragment_position_txv);
		m_ibtnMessage = (ImageButton)view.findViewById(R.id.castellan_fragment_message_ibtn);
		m_ibtnEmail = (ImageButton)view.findViewById(R.id.castellan_fragment_email_ibtn);
		...
		if (m_city!=null) {
			ActionBar actionBar = getActivity().getActionBar();
	        actionBar.setSelectedNavigationItem(getCityListIndex(m_city.getId()));
		}
